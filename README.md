...
- [DIKWP AGI Continuity Ark OS](https://github.com/YucongDuan/DIKWP-AGI-Continuity-Ark-OS) — compact personal and household continuity planning across incompatible AGI futures.
- [DIKWP MINEX Capability Fabric OS](https://github.com/YucongDuan/DIKWP-MINEX-Capability-Fabric-OS) — authority-bounded capability routing and minimum verified expenditure.
- [DIKWP MINEX Fabric OS](https://github.com/YucongDuan/DIKWP-MINEX-FABRIC-OS) — minimum-energy routing, federation, evidence ledgers, and dry-run exchange.
